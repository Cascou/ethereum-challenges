...
describe('[Challenge] Free Rider', function () {
    ...
    //NFT marketplace will have 6 tokens, at 15 ETH each
    ...
    before(async function () {
        ...
        // Approve tokens, and then create Uniswap v2 pair against WETH and add liquidity and deployment
        await token.approve(
        ...
        //Reference to the created Uniswap pair
        ...
        //Ensure deployer owns minted nfts
